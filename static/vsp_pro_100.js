...
function injectNav(){
  ...
  items.forEach(function(it){
    ...
    try{ btn.dataset.proId = it.id; }catch(e){}
    pro.appendChild(btn);
  });
...
PRO.openPanel = function(id){
  ...
  /* __VSP_PRO_NAV_ACTIVE_V1__ */ try { var __ni = document.querySelectorAll('.nav-item'); for (var __i=0;__i<__ni.length;__i++){ var __b=__ni[__i]; __b.classList.remove('active'); if (__b.dataset && __b.dataset.proId === id) __b.classList.add('active'); } } catch(e){}
...
/* __VSP_PRO_NAV_ACTIVE_V1__ close overlay on real-nav click */
try { if (window.showPanel && !window.showPanel.__proWrapped) { var _vspOrigSP = window.showPanel; window.showPanel = function(){ try{ if (window.VSP_PRO && VSP_PRO.closePanel) VSP_PRO.closePanel(); }catch(e){} return _vspOrigSP.apply(this, arguments); }; window.showPanel.__proWrapped = true; } } catch(e){}
