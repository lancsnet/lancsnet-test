...
(function hardenP4Compliance() {
  ...
  events = window.__vspToArrayV19(events);
      ...
      if (!listEl) return;
      listEl.innerHTML = '';
      window.__vspToArrayV19(events).forEach(function(d) {
        var row = document.createElement('div');
  ...
  whenReady(function() { return typeof window.renderRASP === 'function' && document.getElementById('rasp-list'); }, function() {
    window.renderRASP = function(events) {
      ...
      if (!listEl) return;
      listEl.innerHTML = '';
      window.__vspToArrayV19(events).forEach(function(e) {
        var row = document.createElement('div');
...
(function hardenSwInventory() {
  ...
  // F36: renderWhitelist — DISABLED: using real API data
  whenReady(function() { return false; }, function() {
  ...
  // F37: removeFromList — DISABLED: using real API
  whenReady(function() { return false; }, function() {
  ...
  // F38: loadCrackFindings — DISABLED: using real API
  whenReady(function() { return false; }, function() {
  ...
  // F39: loadLicenseData
  whenReady(function() { return false && typeof window.loadLicenseData === 'function'; }, function() {
  ...
  // F40: loadScanHistory
  whenReady(function() { return false && typeof window.loadScanHistory === 'function'; }, function() {
  ...
  // F41: openDetail — DISABLED: using rich version with package list
  whenReady(function() { return false; }, function() {
...
(function hardenIncidentResponse() {
  ...
  whenReady(function() { return typeof window.loadIncidents === 'function' && document.getElementById('inc-tbody'); }, function() {
    window.loadIncidents = async function() {
      try {
        var r = await fetch('/api/p4/ir/incidents');
        var d = await r.json();
  ...
  whenReady(function() { return typeof window.loadPlaybooks === 'function'; }, function() {
    ...
    window.loadPlaybooks = async function() {
      try {
        var r = await fetch('/api/p4/ir/playbooks');
        var d = await r.json();
